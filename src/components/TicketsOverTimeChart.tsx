  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      ...
      >
        ...
        <Legend />
        <Area type="monotone" dataKey="open" stackId="1" stroke="#8884d8" fill="#8884d8" name="Open" />
        <Area type="monotone" dataKey="in progress" stackId="1" stroke="#82ca9d" fill="#82ca9d" name="In Progress" />
        <Area type="monotone" dataKey="resolved" stackId="1" stroke="#ffc658" fill="#ffc658" name="Resolved" />
        <Area type="monotone" dataKey="closed" stackId="1" stroke="#ff7300" fill="#ff7300" name="Closed" />
      </AreaChart>
    </ResponsiveContainer>
  );
};
